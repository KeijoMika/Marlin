...
#define STRING_CONFIG_H_AUTHOR "(Mika S, Geeetech A10 BLTouch TMC2209)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 44.65   // 175.68 189.95
  #define DEFAULT_bedKi 4.07    //  34.59  37.40
  #define DEFAULT_bedKd 326.79   // 223.07 241.19
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -1.750 }
